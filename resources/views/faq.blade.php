...
<section class="cd-faq js-cd-faq container max-width-md margin-top-lg margin-bottom-lg">
	...
	<div class="cd-faq__items">
		<ul id="basics" class="cd-faq__group">
			<li class="cd-faq__title"><h2>Básico</h2></li>
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Cómo cambio mi contraseña?</span></a>
          ...
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Cómo me registro?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Puedo anular un pedido?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Cómo reviso mis pedidos?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
		...
		<ul id="mobile" class="cd-faq__group">
			<li class="cd-faq__title"><h2>Smartphone</h2></li>
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Se puede utilizar desde un smartphone?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Cómo pedir desde un smartphone?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Puedo pagar desde mi smarthphone?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
		...
		<ul id="account" class="cd-faq__group">
          ...
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Cómo salgo de mi sesión?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Cómo edito mis datos?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>Olvidé mi contraseña ¿Cómo puedo restaurarla?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
		...
		<ul id="payments" class="cd-faq__group">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Cuáles son los medios de pago disponibles?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit quidem delectus rerum eligendi mollitia, repudiandae quae beatae. Et repellat quam atque corrupti iusto architecto impedit explicabo repudiandae qui similique aut iure ipsum quis inventore nulla error aliquid alias quia dolorem dolore, odio excepturi veniam odit veritatis. Quo iure magnam, et cum. Laudantium, eaque non? Tempore nihil corporis cumque dolor ipsum accusamus sapiente aliquid quis ea assumenda deserunt praesentium voluptatibus, accusantium a mollitia necessitatibus nostrum voluptatem numquam modi ab, sint rem.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Se puede pagar con chauchas?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Se puede pagar online?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
		...
		<ul id="privacy" class="cd-faq__group">
			<li class="cd-faq__title"><h2>Privacidad</h2></li>
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Cuántas veces puedo cambiar mi contraseña?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit quidem delectus rerum eligendi mollitia, repudiandae quae beatae. Et repellat quam atque corrupti iusto architecto impedit explicabo repudiandae qui similique aut iure ipsum quis inventore nulla error aliquid alias quia dolorem dolore, odio excepturi veniam odit veritatis. Quo iure magnam, et cum. Laudantium, eaque non? Tempore nihil corporis cumque dolor ipsum accusamus sapiente aliquid quis ea assumenda deserunt praesentium voluptatibus, accusantium a mollitia necessitatibus nostrum voluptatem numquam modi ab, sint rem.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Puedo tener más de una dirección asociada?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Mi contraseña es segura?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Los datos de mi tarjeta están seguros?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
		...
		<ul id="delivery" class="cd-faq__group">
			<li class="cd-faq__title"><h2>Restaurant</h2></li>
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Cómo me puedo resgistrar como Restaurant?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit quidem delectus rerum eligendi mollitia, repudiandae quae beatae. Et repellat quam atque corrupti iusto architecto impedit explicabo repudiandae qui similique aut iure ipsum quis inventore nulla error aliquid alias quia dolorem dolore, odio excepturi veniam odit veritatis. Quo iure magnam, et cum. Laudantium, eaque non? Tempore nihil corporis cumque dolor ipsum accusamus sapiente aliquid quis ea assumenda deserunt praesentium voluptatibus, accusantium a mollitia necessitatibus nostrum voluptatem numquam modi ab, sint rem.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Puedo modificar los menús luego de aceptada la solicitud?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Necesito cuenta especial?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><spran>¿Puedo revisar el historial de pedidos realizados a mi Restaurant?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit quidem delectus rerum eligendi mollitia, repudiandae quae beatae. Et repellat quam atque corrupti iusto architecto impedit explicabo repudiandae qui similique aut iure ipsum quis inventore nulla error aliquid alias quia dolorem dolore, odio excepturi veniam odit veritatis. Quo iure magnam, et cum. Laudantium, eaque non? Tempore nihil corporis cumque dolor ipsum accusamus sapiente aliquid quis ea assumenda deserunt praesentium voluptatibus, accusantium a mollitia necessitatibus nostrum voluptatem numquam modi ab, sint rem.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Tengo que pagar algo por el uso de la aplicación?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>¿Qué datos necesito para registrarme?</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
